...
import { CustomerShowAirportsComponent } from './customer-show-airports/customer-show-airports.component';
import { CustomerShowScheduledFlightsComponent } from './customer-show-scheduled-flights/customer-show-scheduled-flights.component';
...
const routes: Routes = [
  ...
  {path: 'customerDashboard', component:CustomerDashboardComponent},
  {path: 'customerShowAirports', component: CustomerShowAirportsComponent},
  {path: 'customerShowScheduledFlights', component: CustomerShowScheduledFlightsComponent}
];
